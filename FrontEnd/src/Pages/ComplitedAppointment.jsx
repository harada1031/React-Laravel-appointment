      ...
      >
        ...
        >
          ...
          <div className="p-6 pt-0 text-center">
            ...
            {!UserData?.isAuthenticated ?  <h3 className="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
              To get an appointment, you must log in!
            ...
            <a
              href={"http://localhost:8000/storage/pdf/" + FilePath}
              download={"FilePath"}
              target="_blank"
